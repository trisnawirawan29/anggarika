...
class GoogleAuthController extends Controller
{
    ...
    public function callback(Request $request): RedirectResponse
    {
        ...
        $user = User::firstOrCreate(['email' => $profile['email']], ['name' => $profile['name'] ?? Str::before($profile['email'], '@'), 'password' => Str::random(40), 'role' => 'user', 'role_id' => Role::where('slug', 'user')->value('id')]);
